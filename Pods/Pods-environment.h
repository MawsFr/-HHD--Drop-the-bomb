...
#define COCOAPODS_VERSION_MINOR_OMPromises 3
#define COCOAPODS_VERSION_PATCH_OMPromises 0

// OMPromises/Core
#define COCOAPODS_POD_AVAILABLE_OMPromises_Core
#define COCOAPODS_VERSION_MAJOR_OMPromises_Core 0
#define COCOAPODS_VERSION_MINOR_OMPromises_Core 3
#define COCOAPODS_VERSION_PATCH_OMPromises_Core 0
